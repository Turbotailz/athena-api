---
title: Powers
description: Access data for hero powers and abilities.
---
...
::code-group
  ```bash [cURL]
  curl https://athena-api.pages.dev/api/powers
  ```

  ```js [JavaScript]
  const response = await fetch('https://athena-api.pages.dev/api/powers');
